...
public class ThreadPoolConfig {
    ...
    @Bean(value = "threadPoolSubmitOrderExecutor")
    public ThreadPoolTaskExecutor threadPoolSubmitOrderExecutor(){
        ThreadPoolTaskExecutor threadPoolTaskExecutor = new ThreadPoolTaskExecutor();
        threadPoolTaskExecutor.setThreadNamePrefix("submitOrder-executor-");
